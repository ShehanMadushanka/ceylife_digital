...
class CeylifeOTPView extends StatefulWidget {
  ...
  /// Colors of the input background. Default is [Colors.lightBlueAccent]
  ...
  /// Colors of the input fields if the [CeylifeOTPView] is disabled. Default is [Colors.grey]
  ...
  CeylifeOTPView({
    ...
    this.fieldHeight = 50,
    this.fieldWidth = 40,
    this.cellBackgroundColor = Colors.lightBlueAccent,
  ...
  @override
  _CeylifeOTPViewState createState() => _CeylifeOTPViewState();
}

class _CeylifeOTPViewState extends State<CeylifeOTPView> {
