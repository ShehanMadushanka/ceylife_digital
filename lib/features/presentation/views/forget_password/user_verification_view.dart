...
class UserVerificationView extends BaseView {
  @override
  _UserVerificationViewState createState() => _UserVerificationViewState();
}

class _UserVerificationViewState extends BaseViewState<UserVerificationView>
              ...
              if (state is InitialPolicyState) {
                  ...
                  if (otpResponseData is OTPResponseData) {
                    if (otpResponseData.isVerificationSuccess) {
                      ...
                      Navigator.pushReplacementNamed(
                          context, Routes.PASSWORD_CREATION_VIEW,
                ...
                showCeylifeDialog(
                  title: AppLocalizations.of(context)
                      .translate('label_user_verification_failed'),
                  ...
                  message: AppLocalizations.of(context)
                      .translate('desc_user_verification_failed'),
                            ...
                            children: [
                              ...
                              Hero(
                                ...
                                child: Material(
                                  ...
                                  child: Text(
                                    AppLocalizations.of(context)
                                        .translate("user_verification_label"),
                                    style: TextStyle(
                                      color: Colors.white,
                              ...
                              CeyLifeTextField(
                                ...
                                hint: AppLocalizations.of(context).translate(
                                    "user_verification_hint_user_id"),
                              ),
                              Spacer(),
                              SizedBox(
                                height: 10,
